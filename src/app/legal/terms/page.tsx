...
export default function TermsPage() {
  return (
    <MarketingShell>
      <InnerHero eyebrow="Legal" title="Terms of service" description="These provisional terms provide a framework for the public site and online platform. Orders and professional services require final commercial terms and legal review." />
      <article className="page-shell legal-copy py-16 sm:py-20">
        ...
        <h2>1. Acceptance and eligibility</h2><p>Use of Driftline services is subject to the terms presented for the applicable website, account, order, or professional engagement.</p>
        ...
        <h2>4. Services and engagements</h2><p>Service availability, scope, pricing, support, and system requirements are those stated at the time of an order. Professional services are governed by a separate written agreement or statement of work.</p>
        ...
        <h2>6. Availability and changes</h2><p>Services may change to improve security, reliability, legal compliance, or system functionality. Maintenance, incidents, and external service failures may affect availability.</p>
