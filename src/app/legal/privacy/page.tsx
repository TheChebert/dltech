...
export default function PrivacyPage() {
  return (
    <MarketingShell>
      ...
      <LegalContent>
        <h2>1. Scope</h2><p>This policy applies to Driftline Tech websites, customer accounts, support channels, and application services that link to it.</p>
        <h2>2. Information we collect</h2><p>The platform may collect account information, contact submissions, support information, security events, and limited technical data needed to operate services.</p>
        <h2>3. How information is used</h2><p>Information is used to provide and secure services, respond to requests, manage customer access and support, investigate abuse, and meet legal obligations.</p>
