...
On 2026-09-03, the real non-production Supabase and deployed API lifecycle passed manual issuance, activation-limit enforcement, deactivation/replacement, live signed-certificate verification through SDK `1.0.0`, refresh-due/offline behavior, suspension, revocation, recovery, and deactivated-token denial.
